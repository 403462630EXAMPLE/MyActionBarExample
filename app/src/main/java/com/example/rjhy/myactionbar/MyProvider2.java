 ...
 *
 * <p>For information about how to use {@link }, see the
 * <a href="{@docRoot}guide/topics/ui/actionbar.html#ActionProvider">Action Bar</a> API guide.</p>
 * </div>
 *
 * @see ActionProvider
 */
public class MyProvider2 extends ActionProvider {
    ...
    public interface OnShareTargetSelectedListener {
         ...
         */
        public boolean onShareTargetSelected(MyProvider2 source, Intent intent);
    }
     ...
     */
    public static final String DEFAULT_SHARE_HISTORY_FILE_NAME = "history1.xml";
     ...
     */
    public MyProvider2(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void setOnShareTargetSelectedListener(OnShareTargetSelectedListener listener) {
        Log.i(MyActivity.TAG, "MyProvider2--setOnShareTargetSelectedListener");
    ...
    public View onCreateActionView() {
        Log.i(MyActivity.TAG, "MyProvider2--onCreateActionView");
...
//                R.string.abc_shareactionprovider_share_with);
    ...
    public boolean hasSubMenu() {
        Log.i(MyActivity.TAG, "MyProvider2--hasSubMenu");
        return true;
    }
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        Log.i(MyActivity.TAG, "MyProvider2--onPrepareSubMenu");
    ...
    public void setShareHistoryFileName(String shareHistoryFile) {
        Log.i(MyActivity.TAG, "MyProvider2--setShareHistoryFileName");
    ...
    public void setShareIntent(Intent shareIntent) {
        Log.i(MyActivity.TAG, "MyProvider2--setShareIntent");
    ...
    private class ShareMenuItemOnMenuItemClickListener implements OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            Log.i(MyActivity.TAG, "MyProvider2--onMenuItemClick");
            ActivityChooserModel dataModel = ActivityChooserModel.get(mContext,
                    mShareHistoryFileName);
    ...
    private void setActivityChooserPolicyIfNeeded() {
        ...
        Log.i(MyActivity.TAG, "MyProvider2--setActivityChooserPolicyIfNeeded");
    ...
    private class ShareActivityChooserModelPolicy implements OnChooseActivityListener {
        ...
        public boolean onChooseActivity(ActivityChooserModel host, Intent intent) {
            Log.i(MyActivity.TAG, "MyProvider2--onChooseActivity");
            if (mOnShareTargetSelectedListener != null) {
                mOnShareTargetSelectedListener.onShareTargetSelected(
                        MyProvider2.this, intent);
            }
            return false;
        }
    }
